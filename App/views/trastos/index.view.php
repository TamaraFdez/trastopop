        ...
        <?php foreach($trastos as $trasto): ?>
            <div class="rounded-lg shadow-md bg-white">
                <div class="p-4">
                    ...
                    <a href="/trasto?id=<? $trasto->id?>" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
                        Detalles
                    </a>
                </div>
            </div>
